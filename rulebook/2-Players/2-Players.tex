...
\begin{deepEnumerate}
	...
	\begin{deepEnumerate}
		...
		\item The team’s primary captain or Assistant GM becomes Interim GM. Their status as a player is unaffected. The League Operation Managers or Moderators can choose the Interim GM at their sole discretion if the primary captain or Assistant-GM is not suitable for any reason.
	\end{deepEnumerate}
	...
	\begin{deepEnumerate}
		...
		\end{deepEnumerate}
	\end{deepEnumerate}
	\item GM Replacement Voting Procedure
	\begin{deepEnumerate}
